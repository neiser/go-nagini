// Package parameter helps adding parameters to commands
package parameter
...
// New constructs a new parameter with any value as a target if that parameter is given.
// The Parser converts from the given string value to the target type.
func New[T any](target *T, defValue T, parser Parser[T]) pflag.Value {
	*target = defValue
